...
router.get(
  '/merchants',
  requireAuth,
  requireCapability('workspace.merchant.view'),
...
router.post(
  '/merchants',
  requireAuth,
  requireCapability('workspace.merchant.editDraft'),
  (req: AuthenticatedRequest, res, next) => {
    try {
...
router.post(
  ...
  requireAuth,
  requireCapability('workspace.merchant.reviewPublish'),
  (req: AuthenticatedRequest, res, next) => {
    try {
      const merchantId = String(req.params.merchantId);
